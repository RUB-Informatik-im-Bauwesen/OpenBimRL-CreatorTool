<template>
    <div id="viewerContainer">
        <reactFlow id="reactflowviewer" style="width: 100%; height: 100%;" :elements="localElements"
            :nodeTypes="nodeTypes" :onMove="onMove" :onDragOver="onDragOver" :onDrop="onDrop"
            :onEdgeUpdate="onEdgeUpdate" :onConnect="onConnect" :onSelectionChange="onSelectionChange"
            :onNodeDoubleClick="onNodeDoubleClick" :onNodeDragStop="onNodeDragStop" :onNodeDrag="onNodeDrag"
            :defaultZoom="$store.state.viewer.currentZoom" :minZoom="$store.state.viewer.minZoom"
